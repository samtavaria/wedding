...
<body>
	...
	<div id="Layout_Selection" style = "float: left; width:40%">
		<p> Select a template</p></br>
					...
					<img class="template_icon selected" title="Title 1" width = "160" height = "120" src="invitation_card_backgrounds_preview/1.jpeg" onmouseover="showImage1();"  />



					<img class="template_icon" title="Title 2" width = "160" height = "120" src="invitation_card_backgrounds_preview/2.jpeg" onmouseover="showImage2();"/>



					<img class="template_icon" title="Title 3" width = "160" height = "120" src="invitation_card_backgrounds_preview/3.jpeg" onmouseover="showImage3();" />
